...
export const addons: PresetProperty<'addons', StorybookConfig> = [
  dirname(require.resolve(join('@storybook/preset-html-webpack', 'package.json'))),
  dirname(require.resolve(join('@storybook/html', 'package.json'))),
];
...
export const webpack: StorybookConfig['webpack'] = async (config) => {
  ...
  config.resolve.alias = {
    ...
    '@storybook/html': dirname(require.resolve(join('@storybook/html', 'package.json'))),
