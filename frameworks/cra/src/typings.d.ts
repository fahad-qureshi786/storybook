...
declare module 'pnp-webpack-plugin' {
  import { ResolvePluginInstance } from 'webpack'; // eslint-disable-line import/no-extraneous-dependencies

  const moduleLoader: (module: NodeModule) => ResolvePluginInstance;
}
